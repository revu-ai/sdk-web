...
[![wire](https://img.shields.io/badge/brotli-9.56%20kB-blue)](#size)
[![gzip](https://img.shields.io/badge/gzip-10.63%20kB-blue)](#size)
...
ESM only. **Zero runtime dependencies.** 9.56 kB brotli on the wire, 10.63 kB gzipped.
...
(9.56 kB on the wire for the current version).
...
| -------------------------- | -------- | -------- |
| Brotli on the wire         | 9.56 kB  | 10 kB    |
| Gzipped (fallback path)    | 10.63 kB | 11.5 kB  |
| Minified (parse cost)      | 34.66 kB | 37.5 kB  |
