...
[![size](https://img.shields.io/badge/min-28.14%20kB-blue)](#size)
[![gzip](https://img.shields.io/badge/gzip-8.89%20kB-blue)](#size)
...
ESM only. **Zero runtime dependencies.** 28.14 kB minified, 8.89 kB gzipped.
...
| --------------- | ------- | ------ |
| Minified        | 28.14 kB | 30 kB  |
| Gzipped on wire | 8.89 kB  | 10 kB  |
...
as around 7.9 kB on the wire for browsers that advertise brotli, with
