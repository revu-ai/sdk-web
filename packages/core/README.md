...
[![wire](https://img.shields.io/badge/brotli-9.53%20kB-blue)](#size)
[![gzip](https://img.shields.io/badge/gzip-10.6%20kB-blue)](#size)
...
ESM only. **Zero runtime dependencies.** 9.53 kB brotli on the wire, 10.6 kB gzipped.
...
(9.53 kB on the wire for the current version).
...
| -------------------------- | -------- | -------- |
| Brotli on the wire         | 9.53 kB  | 10 kB    |
| Gzipped (fallback path)    | 10.6 kB  | 11.5 kB  |
| Minified (parse cost)      | 34.55 kB | 37.5 kB  |
