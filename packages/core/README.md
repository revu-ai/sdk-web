...
[![wire](https://img.shields.io/badge/brotli-9.35%20kB-blue)](#size)
[![gzip](https://img.shields.io/badge/gzip-10.41%20kB-blue)](#size)
...
ESM only. **Zero runtime dependencies.** 9.35 kB brotli on the wire, 10.41 kB gzipped.
