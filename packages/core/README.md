...
[![wire](https://img.shields.io/badge/brotli-9.46%20kB-blue)](#size)
[![gzip](https://img.shields.io/badge/gzip-10.52%20kB-blue)](#size)
...
ESM only. **Zero runtime dependencies.** 9.46 kB brotli on the wire, 10.52 kB gzipped.
...
(9.46 kB on the wire for the current version).
...
| -------------------------- | -------- | -------- |
| Brotli on the wire         | 9.46 kB  | 10 kB    |
| Gzipped (fallback path)    | 10.52 kB | 11.5 kB  |
| Minified (parse cost)      | 34.21 kB | 37.5 kB  |
