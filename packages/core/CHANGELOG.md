...
- **Bundle size: 9.35 kB brotli on the wire / 10.41 kB gzipped / 34.01 kB minified**, plus 0.83 kB brotli for the vitals plugin if you import it. The `<script>` bundle, which includes the plugin, is 9.9 kB brotli. The chunked queue accounts for around 0.27 kB of that and buys a 25x reduction in append cost at depth.
